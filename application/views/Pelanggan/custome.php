<!-- Page Header Start -->
<img style="height: 400px; width: 1340px;" src="<?php echo base_url('asset/malaysia.jpg'); ?>" class="container-fluid bg-secondary mb-5">
<!-- Page Header End -->
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="control-group">
							...
							<input type="number" name="qty" class="form-control" id="subject" placeholder="Masukkan Quantity Pemesanan" />
							<?= form_error('pundak', '<p class="help-block text-danger">', '</p>') ?>
						</div>
					</div>
				</div>
