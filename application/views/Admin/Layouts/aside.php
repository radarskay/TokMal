	...
	<ul class="sidebar-nav" id="sidebar-nav">
		...
		<li class="nav-item">
			<a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
				<i class="bi bi-journal-text"></i><span>Kelola Data Admin</span><i class="bi bi-chevron-down ms-auto"></i>
			</a>
		...
		<li class="nav-item">
			<a class="nav-link collapsed" href="<?= base_url('Admin/TransaksiLangsung') ?>">
		...
		<li class="nav-item">
			<a class="nav-link collapsed" href="<?= base_url('Admin/CustomLangsung') ?>">
				<i class="bi bi-grid"></i>
				<span>Custom Langsung</span>
			</a>
		</li><!-- End Dashboard Nav -->
		<li class="nav-item">
