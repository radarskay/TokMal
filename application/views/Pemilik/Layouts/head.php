...
<head>
  ...
  <!-- Google <?= base_url('asset/NiceAdmin/') ?>Fonts -->
  <link href="<?= base_url('asset/NiceAdmin/') ?>https://fonts.gstatic.com" rel="preconnect">
  <link href="<?= base_url('asset/NiceAdmin/') ?>https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Nunito:300,300i,400,400i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
